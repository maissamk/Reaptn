...
$catalogue = new MessageCatalogue('fake_locale', array (
));

$catalogueFake = new MessageCatalogue('fake', array (
));
$catalogue->addFallbackCatalogue($catalogueFake);
...
$catalogueFake->addFallbackCatalogue($catalogueFr);
