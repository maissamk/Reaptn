 ...
 */
class getParcelleProprietesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParcelleProprietesRepository' shared autowired service.
     *
     * @return \App\Repository\ParcelleProprietesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParcelleProprietesRepository.php';

        return $container->privates['App\\Repository\\ParcelleProprietesRepository'] = new \App\Repository\ParcelleProprietesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
