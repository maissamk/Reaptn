...
return [
    ...
    'admin_materielvente_new' => [[], ['_controller' => 'App\\Controller\\AdminController::new'], [], [['text', '/admin/materielvente/new']], [], [], []],
    'admin_materielvente_edit' => [['id'], ['_controller' => 'App\\Controller\\AdminController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true]], [], [], []],
    'admin_materielvente_delete' => [['id'], ['_controller' => 'App\\Controller\\AdminController::delete'], [], [['variable', '/', '[^/]++', 'id', true]], [], [], []],
    ...
    'App\Controller\AdminController::new' => [[], ['_controller' => 'App\\Controller\\AdminController::new'], [], [['text', '/admin/materielvente/new']], [], [], []],
    'App\Controller\AdminController::edit' => [['id'], ['_controller' => 'App\\Controller\\AdminController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true]], [], [], []],
    'App\Controller\AdminController::delete' => [['id'], ['_controller' => 'App\\Controller\\AdminController::delete'], [], [['variable', '/', '[^/]++', 'id', true]], [], [], []],
