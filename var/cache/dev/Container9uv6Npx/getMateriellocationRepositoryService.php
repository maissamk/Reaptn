 ...
 */
class getMateriellocationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MateriellocationRepository' shared autowired service.
     *
     * @return \App\Repository\MateriellocationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MateriellocationRepository.php';

        return $container->privates['App\\Repository\\MateriellocationRepository'] = new \App\Repository\MateriellocationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
