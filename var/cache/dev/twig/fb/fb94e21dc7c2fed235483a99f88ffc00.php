...
class __TwigTemplate_7d96922e1bb75742d2ccae8a1f722e30 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_parcelle_proprietes_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["contrat"]) || array_key_exists("contrat", $context) ? $context["contrat"] : (function () { throw new RuntimeError('Variable "contrat" does not exist.', 1, $this->source); })()), "id", [], "any", false, false, false, 1)]), "html", null, true);
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('admin_parcelle_proprietes_delete', {'id': contrat.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ contrat.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "admin/contrat/_delete_form.html.twig", "C:\\Users\\DELL\\Downloads\\projet\\Reaptn\\templates\\admin\\contrat\\_delete_form.html.twig");
    }
}
