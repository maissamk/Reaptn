...
class __TwigTemplate_872d0ec302e47c9b6d41657d02169fbc extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <!-- Set top margin to 30px to create space between navbar and content -->
    <div class=\"container mt-10\" style=\"margin-top: 70px;\">
        ...
        <div class=\"text-center mb-4\">
            <h1 class=\"display-4 text-warning\">Reset your password</h1>
        </div>
        ...
        <div class=\"card shadow-lg p-4\">
            ";
        // line 19
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 19, $this->source); })()), 'form_start');
        yield "
        ...
        yield "
                ...
                <button class=\"btn btn-primary btn-lg w-100 mt-4\">Send password reset email</button>
            ";
        // line 33
...
";
    ...
    {
        return array (  147 => 33,  133 => 22,  127 => 19,  117 => 11,  108 => 9,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    <!-- Set top margin to 30px to create space between navbar and content -->
    <div class=\"container mt-10\" style=\"margin-top: 70px;\">
...
{% endblock %}
", "reset_password/request.html.twig", "C:\\Users\\romdh\\OneDrive\\Bureau\\New folder\\Reaptn\\templates\\reset_password\\request.html.twig");
    }
}
