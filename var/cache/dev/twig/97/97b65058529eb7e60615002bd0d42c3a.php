...
class __TwigTemplate_b905221b550ed1188b0fc45604078e9e extends Template
{
        ...
        <div class=\"col-md-8\">
            <div class=\"card shadow-lg p-4\">
                <h1 class=\"text-center text-primary fw-bold mb-4\">
                    ...
                    <i class=\"fas fa-file-signature\"></i> Créer une nouvelle catégorie
                </h1>
        ...
        <div class=\"col-md-8\">
            <div class=\"card shadow-lg p-4\">
                ...
                <div class=\"card-body\">
                    ...
                    <div class=\"text-center mt-4\">
                        <a href=\"{{ path('app_categorie') }}\" class=\"btn btn-secondary btn-lg\">
                            <i class=\"fas fa-arrow-left\"></i> Retour à la liste
                        </a>
                    </div>
                </div>
...
{% endblock %}
", "categorie/new.html.twig", "C:\\Users\\romdh\\OneDrive\\Bureau\\New folder\\Reaptn\\templates\\categorie\\new.html.twig");
    }
}
