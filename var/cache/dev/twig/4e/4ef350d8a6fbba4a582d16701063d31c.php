...
class __TwigTemplate_a2dfc77988605561ee0f8c1391eba154 extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["paiement"]) || array_key_exists("paiement", $context) ? $context["paiement"] : (function () { throw new RuntimeError('Variable "paiement" does not exist.', 16, $this->source); })()), "datePaiement", [], "any", false, false, false, 16)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, (isset($context["paiement"]) || array_key_exists("paiement", $context) ? $context["paiement"] : (function () { throw new RuntimeError('Variable "paiement" does not exist.', 16, $this->source); })()), "datePaiement", [], "any", false, false, false, 16), "Y-m-d"), "html", null, true)) : (""));
        yield "</td>
            </tr>
            <tr>
                ...
                <td>";
        // line 20
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["paiement"]) || array_key_exists("paiement", $context) ? $context["paiement"] : (function () { throw new RuntimeError('Variable "paiement" does not exist.', 20, $this->source); })()), "methodePaiement", [], "any", false, false, false, 20), "html", null, true);
        yield "</td>
            </tr>
        </tbody>
    </table>
...
{% block body %}
    ...
    <a href=\"{{ path('app_paiement_index') }}\">back to list</a>

    <a href=\"{{ path('app_paiement_edit', {'id': paiement.id}) }}\">edit</a>

    {{ include('paiement/_delete_form.html.twig') }}
{% endblock %}
", "paiement/show.html.twig", "C:\\Users\\romdh\\OneDrive\\Bureau\\PI2025\\Reaptn\\templates\\paiement\\show.html.twig");
    }
}
