...
class __TwigTemplate_80083708fd9372de641141bcc3940acd extends Template
{
...
<div class=\"container\">
    ...
    <table class=\"table table-striped table-hover\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["commandes"]) || array_key_exists("commandes", $context) ? $context["commandes"] : (function () { throw new RuntimeError('Variable "commandes" does not exist.', 82, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["commande"]) {
            ...
            yield "                <tr>
                    <td>";
            // line 84
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["commande"], "id", [], "any", false, false, false, 84), "html", null, true);
            yield "</td>
                    <td>";
            // line 85
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["commande"], "idCommande", [], "any", false, false, false, 85), "html", null, true);
            yield "</td>
                    <td>";
            // line 86
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["commande"], "dateCommande", [], "any", false, false, false, 86)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["commande"], "dateCommande", [], "any", false, false, false, 86), "Y-m-d H:i:s"), "html", null, true)) : ("N/A"));
            yield "</td>
                    <td>";
            // line 87
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["commande"], "totale", [], "any", false, false, false, 87), "html", null, true);
            yield " DT</td>
                    <td>";
            // line 88
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["commande"], "quantite", [], "any", false, false, false, 88), "html", null, true);
            yield "</td>
                    <td>
                        <a href=\"";
            // line 90
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_commande_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["commande"], "id", [], "any", false, false, false, 90)]), "html", null, true);
            yield "\" class=\"btn btn-info btn-sm\">Afficher</a>
                        <a href=\"";
            // line 91
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_commande_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["commande"], "id", [], "any", false, false, false, 91)]), "html", null, true);
    ...
    <a href=\"";
        ...
        yield "\" class=\"btn btn-primary\">Créer une nouvelle commande</a>
</div>
...
";
    ...
    {
        return array (  335 => 172,  262 => 102,  257 => 99,  248 => 95,  246 => 94,  238 => 91,  234 => 90,  229 => 88,  225 => 87,  221 => 86,  217 => 85,  213 => 84,  210 => 83,  205 => 82,  165 => 45,  158 => 41,  154 => 40,  150 => 39,  146 => 38,  139 => 34,  135 => 33,  131 => 32,  121 => 25,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<div class=\"container\">
        ...
        <tbody>
            {% for commande in commandes %}
                <tr>
                    ...
                    <td>
                        <a href=\"{{ path('app_commande_show', {'id': commande.id}) }}\" class=\"btn btn-info btn-sm\">Afficher</a>
    ...
    <a href=\"{{ path('app_commande_new') }}\" class=\"btn btn-primary\">Créer une nouvelle commande</a>
</div>
...
{% endblock %}
", "commande/index.html.twig", "C:\\Users\\asus\\Desktop\\PI2025\\pi2025\\templates\\commande\\index.html.twig");
    }
}
