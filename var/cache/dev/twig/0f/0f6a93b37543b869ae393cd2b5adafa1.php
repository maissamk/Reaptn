...
class __TwigTemplate_62292b9e99969c6e38bba73da93ef098 extends Template
{
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_commande_delete', {'id': commande.id}) }}\" 
      onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cet élément ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ commande.id) }}\">
    <button class=\"btn btn-danger btn-sm\">Supprimer</button>
</form>
", "commande/_delete_form.html.twig", "C:\\Users\\romdh\\OneDrive\\Bureau\\New folder\\Reaptn\\templates\\commande\\_delete_form.html.twig");
    }
}
