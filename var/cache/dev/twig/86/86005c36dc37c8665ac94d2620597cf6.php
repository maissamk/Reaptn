...
class __TwigTemplate_b88c32edcbf59aa96619d4e898a4992c extends Template
{
    ...
    <div class=\"row justify-content-center\"> <!-- Centrer la ligne -->
        ...
        yield "\" class=\"btn btn-warning\">Éditer</a>
            ...
            <div class=\"mt-4\">
                ";
        // line 36
        yield Twig\Extension\CoreExtension::include($this->env, $context, "categorie/delete.html.twig");
        yield "
            </div>
        </div>
    </div>
...
";
    ...
    {
        return array (  147 => 36,  140 => 32,  136 => 31,  127 => 25,  120 => 21,  113 => 17,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
        ...
        <div class=\"col-md-8\"> <!-- Largeur de la colonne -->
            <table class=\"table table-bordered\">
                <tbody>
                    ...
                    <tr>
                        <th>Nom</th>
                        <td><span class=\"text-primary\">{{ categorie.nom }}</span></td>
                    </tr>
                    <tr>
                        <th>Description</th>
            ...
            <div class=\"d-flex justify-content-between mt-4\">
                <a href=\"{{ path('app_categorie') }}\" class=\"btn btn-secondary\">Retour à la liste</a>
                <a href=\"{{ path('app_categorie_edit', {'id': categorie.id}) }}\" class=\"btn btn-warning\">Éditer</a>
            </div>

            <div class=\"mt-4\">
                {{ include('categorie/delete.html.twig') }}
            </div>
        </div>
    </div>
</div>
...
{% endblock %}
", "categorie/show.html.twig", "C:\\Users\\romdh\\OneDrive\\Bureau\\New folder\\Reaptn\\templates\\categorie\\show.html.twig");
    }
}
