...
class __TwigTemplate_5471bc39e166119759ffc50235adaad2 extends Template
{
...
";
        // line 11
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), 'form_start', ["attr" => ["novalidate" => "novalidate", "class" => "container mt-4 p-4 bg-light rounded shadow"]]);
        yield "
...
<div class=\"d-flex justify-content-center mt-4\">
            <a href=\"{{ path('app_categorie') }}\" class=\"btn btn-primary me-3\">
                <i class=\"fa fa-arrow-left\"></i> Retour
            </a>
...
{% endblock %}
", "categorie/edit.html.twig", "C:\\Users\\romdh\\OneDrive\\Bureau\\New folder\\Reaptn\\templates\\categorie\\edit.html.twig");
    }
}
