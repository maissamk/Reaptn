...
class __TwigTemplate_054e3b404c853bef82c56214febac214 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["offre"]) || array_key_exists("offre", $context) ? $context["offre"] : (function () { throw new RuntimeError('Variable "offre" does not exist.', 50, $this->source); })()), "employes", [], "any", false, false, false, 50));
        ...
        yield "            </ul>
            ...
            <form action=\"";
        // line 63
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_employe_new", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["offre"]) || array_key_exists("offre", $context) ? $context["offre"] : (function () { throw new RuntimeError('Variable "offre" does not exist.', 63, $this->source); })()), "id", [], "any", false, false, false, 63)]), "html", null, true);
        yield "\" method=\"POST\">
                <div class=\"mb-3\">
...
";
    ...
    {
        return array (  222 => 78,  204 => 63,  196 => 57,  189 => 55,  187 => 56,  178 => 52,  175 => 51,  170 => 50,  160 => 43,  152 => 38,  145 => 34,  138 => 30,  131 => 26,  124 => 22,  117 => 18,  110 => 14,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    <div class=\"pt-5\">
        <div class=\"container mt-5 pt-5\">
            ...
            <a href=\"{{ path('app_offre_index') }}\" class=\"btn btn-secondary\">Back to List</a>
...
{% endblock %}", "offre/show.html.twig", "C:\\Users\\LENOVO\\Desktop\\PI2025\\Reaptn\\templates\\offre\\show.html.twig");
    }
}
