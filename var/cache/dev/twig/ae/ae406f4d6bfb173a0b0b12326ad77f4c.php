...
class __TwigTemplate_4ff9c428cf4cab6be5951d96d1e3ddec extends Template
{
    ...
    <table class=\"table table-bordered\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 17
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["commande"]) || array_key_exists("commande", $context) ? $context["commande"] : (function () { throw new RuntimeError('Variable "commande" does not exist.', 17, $this->source); })()), "idCommande", [], "any", false, false, false, 17), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <th>Date</th>
                <td>";
        // line 21
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["commande"]) || array_key_exists("commande", $context) ? $context["commande"] : (function () { throw new RuntimeError('Variable "commande" does not exist.', 21, $this->source); })()), "dateCommande", [], "any", false, false, false, 21)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, (isset($context["commande"]) || array_key_exists("commande", $context) ? $context["commande"] : (function () { throw new RuntimeError('Variable "commande" does not exist.', 21, $this->source); })()), "dateCommande", [], "any", false, false, false, 21), "Y-m-d H:i:s"), "html", null, true)) : ("N/A"));
        yield "</td>
            </tr>
            <tr>
                <th>Total</th>
        ...
        yield " €</td>
            ...
            <tr>
                ...
                <td>";
        // line 29
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["commande"]) || array_key_exists("commande", $context) ? $context["commande"] : (function () { throw new RuntimeError('Variable "commande" does not exist.', 29, $this->source); })()), "quantite", [], "any", false, false, false, 29), "html", null, true);
        yield "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  154 => 37,  149 => 35,  145 => 34,  137 => 29,  130 => 25,  123 => 21,  116 => 17,  109 => 13,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<div class=\"container\">
    ...
    <a href=\"{{ path('app_commande_edit', {'id': commande.id}) }}\" class=\"btn btn-warning mt-3\">Modifier</a>

    {{ include('commande/_delete_form.html.twig') }}
</div>
{% endblock %}
", "commande/show.html.twig", "C:\\Users\\romdh\\OneDrive\\Bureau\\New folder\\Reaptn\\templates\\commande\\show.html.twig");
    }
}
