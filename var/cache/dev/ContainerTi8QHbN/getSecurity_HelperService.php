...
class getSecurity_HelperService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.helper'] = new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Security\\FaceLoginFormAuthenticator' => ['privates', 'App\\Security\\FaceLoginFormAuthenticator', 'getFaceLoginFormAuthenticatorService', true],
            'App\\Security\\LoginFormAuthenticator' => ['privates', 'App\\Security\\LoginFormAuthenticator', 'getLoginFormAuthenticatorService', true],
            'App\\Service\\GoogleAuthenticator' => ['privates', 'App\\Service\\GoogleAuthenticator', 'getGoogleAuthenticatorService', true],
        ...
        ]), 'face_login' => NULL, 'admin' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Security\\LoginFormAuthenticator' => ['privates', 'App\\Security\\LoginFormAuthenticator', 'getLoginFormAuthenticatorService', true],
