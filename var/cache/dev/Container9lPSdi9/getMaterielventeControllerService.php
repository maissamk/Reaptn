...
class getMaterielventeControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'ImageAnalysisService.php';

        $container->services['App\\Controller\\MaterielventeController'] = $instance = new \App\Controller\MaterielventeController(new \App\Service\ImageAnalysisService($container->getEnv('HUGGINGFACE_API_KEY')));
