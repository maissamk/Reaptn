 ...
 */
class getLandPropertiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LandPropertiesRepository' shared autowired service.
     *
     * @return \App\Repository\LandPropertiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LandPropertiesRepository.php';

        return $container->privates['App\\Repository\\LandPropertiesRepository'] = new \App\Repository\LandPropertiesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
