 ...
 */
class getMaterielventeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MaterielventeRepository' shared autowired service.
     *
     * @return \App\Repository\MaterielventeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MaterielventeRepository.php';

        return $container->privates['App\\Repository\\MaterielventeRepository'] = new \App\Repository\MaterielventeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
