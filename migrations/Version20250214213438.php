 ...
 */
final class Version20250214213438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD user_identifier INT NOT NULL, CHANGE idoffre offre_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD idoffre INT NOT NULL, DROP offre_id, DROP user_identifier');
    }
}
