 ...
 */
final class Version20250218125106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE materielvente DROP categorie_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE materielvente ADD categorie_id INT DEFAULT NULL');
